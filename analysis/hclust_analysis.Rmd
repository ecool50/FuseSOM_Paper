...
# res.corr.jackson <- lapply(jackson_subsets, run_corr, markers = jackson_markers, 
#                            corr_metrics = corr_metrics, mc.cores = 64) %>% bind_rows()
# res.prox.jackson <- lapply(jackson_subsets, run_prox, markers = jackson_markers, 
...
gc()
p.orig <- ggplot(umap_df, aes(x=`UMAP 1`, y=`UMAP 2`)) + geom_point(aes(color=CellType)) + 
  theme_bw() + 
...
p.pear <- ggplot(umap_df, aes(x=`UMAP 1`, y=`UMAP 2`)) + geom_point(aes(color=pear.clusts)) + 
  theme_bw() + theme(legend.position="none") + 
...
p.eucl <- ggplot(umap_df, aes(x=`UMAP 1`, y=`UMAP 2`)) + geom_point(aes(color=eucl.clusts)) + 
  theme_bw() + theme(legend.position="none") + 
...
p.max <- ggplot(umap_df, aes(x=`UMAP 1`, y=`UMAP 2`)) + geom_point(aes(color=max.clusts)) + 
  theme_bw() + theme(legend.position="none") + 
